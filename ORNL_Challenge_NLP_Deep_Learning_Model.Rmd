---
title: "ORNL Deep Learning NLP Model for Data Science Challenge"
author: "Jerome Dixon"
date: "8/7/2020"
...
sample_dl_df <- final_DL_df %>% filter(pareto == 1 & eigencentrality > 0)
...
nlp_data[,1:5] <- as.numeric(nlp_data[,1:5])
...
x_train <- nlp_data[indx == 1, 1:4]
x_test <- nlp_data[indx == 2, 1:4]

y_test_actual <- nlp_data[indx == 2, 5]


y_train <- to_categorical(nlp_data[indx == 1, 5])
y_test <- to_categorical(nlp_data[indx == 2, 5])
