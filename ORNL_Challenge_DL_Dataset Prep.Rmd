...
base_url <- "https://clinicaltrialsapi.cancer.gov/v1/clinical-trials?size=30&include=official_title&include=brief_summary&anatomic_sites"
...
write.csv(DL_df, "data/nlp_out/Deep_Learning_Dataset.csv")
...
write.csv(DL_input, paste0("data/nlp_out/DL_DF_Addendum.csv"))
...
write.csv(sample_dl_df, paste0("data/nlp_final/DL_DF_sample.csv"))
